...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="11"><%if lx="一般房屋" then%><img src="image/ws-01.jpg"><%end if%><%if lx="高級公寓" then%><img src="image/ws-02.jpg"><%end if%><%if lx="花園洋房" then%><img src="image/ws-03.jpg"><%end if%><%if lx="豪華別墅" then%><img src="image/ws-04.jpg"><%end if%> </td>                 
...
<td height="1" width="159" bgcolor="#C4DEFF">在臥室裡休息每小時</td>                 
</tr><tr>
<td height="1" width="159" bgcolor="#C4DEFF">加內力1000體力1000</td>                 
</tr><tr>
<td height="1" width="159" bgcolor="#C4DEFF">不需要銀兩。</td>                 
</tr><tr>
...
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">當前位置：臥室</font></p>
</td>                 
