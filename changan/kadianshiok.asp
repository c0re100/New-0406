...
<center>
<%
conn.execute "update 用戶 set 攻擊=攻擊+1,操作時間=now() where id="&info(9)
rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
Response.Write "<script language=JavaScript>{alert('你痛痛快快地看完電視裡的武打鏡頭，攻擊力上升1點！');location.href = 'kadianshi.asp';}</script>"
Response.End%>
</body>
</html>