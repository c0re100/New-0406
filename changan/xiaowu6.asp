...
rs.open "select 性別 from 用戶 where id="&info(9),conn
sex=rs("性別")
rs.close
	set rs=nothing	
	conn.close
...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="10"><%if lx="花園洋房" then%><img src="image/hy-01.jpg"><%end if%><%if lx="豪華別墅" then%><img src="image/hy-02.jpg"><%end if%> </td>                 
<td height="13" width="159" bgcolor="#C4DEFF">
 <p align="center"><a href="zhongzhi.asp"><font color="#000000">種花</font></a></p> 
</td>                 
</tr>
<tr>
...
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">當前位置：花園</font></p>
</td>                 
