...
<center>
<%
conn.execute "update 用戶 set 內力=內力+20,操作時間=now() where id="&info(9)
rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
Response.Write "<script language=JavaScript>{alert('你細嚼慢咽的喫完了漢堡，精神好多了，內力提升20點！');location.href = 'chifan.asp';}</script>"
Response.End
%>
</body>
</html>