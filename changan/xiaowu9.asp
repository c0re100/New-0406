...
sql="select 性別,魅力,道德 from 用戶 where id="&info(9)
...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="10"><%if lx="花園洋房" then%><img src="image/sf-01.jpg"><%end if%><%if lx="豪華別墅" then%><img src="image/sf-02.jpg"><%end if%> </td>                 
</tr>
...
<td height="164" width="102" bgcolor="#C4DEFF">
 <p align="center"><a href="/xywl/html/xiashuo/indexxiao.htm"><font color="#000000">看書</font></a></p> 
</td>                 
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">當前位置：書房</font></p>
</td>                 
