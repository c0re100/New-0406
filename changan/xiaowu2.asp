...
sql="SELECT 物品名,數量 FROM 物品 where  擁有者="&info(9)
Set Rs=conn.Execute(sql)
name=info(0)
%>
<html>
...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="11"><%if lx="一般房屋" then%><img src="image/ccs-01.jpg"><%end if%><%if lx="高級公寓" then%><img src="image/ccs-02.jpg"><%end if%><%if lx="花園洋房" then%><img src="image/ccs-03.jpg"><%end if%><%if lx="豪華別墅" then%><img src="image/ccs-04.jpg"><%end if%> </td>                 
<td height="1" width="200" bgcolor="#C4deff"><center>物品名</center></td>
<td height="1" width="159" bgcolor="#C4deff"><center>數量</center></td>
...
%>
<tr>
<td height="1" width="200" bgcolor="#C4DEFF"><center><%=rs("物品名")%></center></td>
<td height="1" width="159" bgcolor="#C4DEFF"><center><%=rs("數量")%></center></td>
...
<td height="164" width="102" bgcolor="#C4DEFF">
    <p align="center"><a href="../hcjs/es/wupin.asp" target="_blank"><font color="#000000">我的東西</font></a></p> 
</td>                 
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">當前位置：儲藏室</font></p>
</td>                 
...
<td height="164" width="78" bgcolor="#C4DEFF">
  <p align="center"><a href="../hcjs/es/wupin.asp" width="100" height="400" target="_blank"><font color="#000000">隨身包裹</font></a></p>
</td>                                  
</tr>
</table>
