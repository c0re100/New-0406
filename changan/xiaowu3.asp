...
sql="select 性別,體力 from 用戶 where id="&info(9)
...
Set rs=Server.CreateObject("ADODB.RecordSet")
conn.open Application("ljjh_usermdb")
sql="SELECT 物品名,數量 FROM 物品 where 類型='藥品' and 擁有者="&info(9)
Set Rs=conn.Execute(sql)
name=info(0)
%>
<html>
...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="10"><%if lx="高級公寓" then%><img src="image/ct-01.jpg"><%end if%><%if lx="花園洋房" then%><img src="image/ct-02.jpg"><%end if%><%if lx="豪華別墅" then%><img src="image/ct-03.jpg"><%end if%> </td>                 
<td height="1" width="159" bgcolor="#C4deff"><center>物品名</center></td>
...
%>
<tr>
<td height="1" width="159" bgcolor="#C4DEFF"><center><%=rs("物品名")%></center></td>
...
<td height="164" width="102" bgcolor="#C4DEFF">
  <p align="center"><a href="chifan.asp"><font color="#000000">我要喫飯</font></a></p> 
</td>                 
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">當前位置：餐廳</font></p>
</td>                 
...
<td height="164" width="157" bgcolor="#C4DEFF">
  <p align="center"><font color="#ff0000">體力：<%=ti%></font></p>
</td>                                  
</tr>
</table>
