...
<td width="96" height="18" bgcolor="#FFFF00"><div align="center"><font color="#CC0000"> 搶劫令 </font></div></td></tr>
<tr>
<td height="20" bgcolor="#FF0000"> 
<div align="left"><font size="2" color="#FFFFFF">戰鬥級大於10級<br>
<br>
對像：不限<br>
<br>
法力：10000點<br>
<br>
效果：搶得對方存款的5分之一</font></div></td>
</tr>
<tr> 
<td height="4" bgcolor="#FF6633"><div align="center"> 
<form method=POST action=fq004ok.asp>
...
<div align="center"> <br>
<input type=submit value="使用法器" name=submit style="border: 2px solid;background-color:#ffffff; font-size: 9pt; border-color:#000000 solid">
</div></td>
</tr>
</table></TD>
