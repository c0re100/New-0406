...
<table border="1" cellspacing="0" cellpadding="1" width="135" bordercolorlight="#000000" bordercolordark="#FFFFFF" align="center" height="398" >
  <tr  onMouseOut="this.bgColor='#FFFFFF';"onMouseOver="this.bgColor='#DFEFFF';"> 
    <td bgcolor="#EEFFEE" height="31"> 
      <div align="center"><font color="#FF6633"> 銀兩賭局下注 </font></div>
    </td>
  </tr>
  <tr> 
    <td bgcolor="#FF6633" height="52"> 
      <div align="left"> 
        <p> <font color="#FFFFFF">銀兩賭局:最少10萬,最多500萬</font> 
      </div>
    </td>
  </tr>
  <tr> 
    <td height="86" bgcolor="#FF6633"> 
      <form method=POST action=duju002ok.asp>
...
#000000 solid">
          ...
          <font color=#EEFFEE size=2> </font> </div>
      </form>
    </td>
  </tr>
  <tr> 
    <td height="9" bgcolor="#FF6633"> 
      <form method=POST action=duju002ok.asp>
