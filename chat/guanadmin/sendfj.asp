...
randomize timer
s=int(rnd*100)+132
diaox="<font color=#FFC01F>路經此地，特為聊天室裡的各大小蝦送上金幣<font color=#FFC01F>"& s &"</font>個</font>"
Set conn=Server.CreateObject("ADODB.CONNECTION")
conn.open Application("ljjh_usermdb")
for i=0 to x
	conn.Execute"update 用戶 set 金幣=金幣+" & s & "  where 姓名='" & online(i) & "'"
next
conn.close
set conn=nothing
Application.Lock
...
sd(197)="FFC01F"
sd(198)="對"
sd(199)="<font color=#FFC01F>【發金幣】"&info(0)&""& diaox &"</font>"
