...
randomize timer
s=int(rnd*10)+142
diaox="<font color=#FFC01F>路經此地，特為聊天室裡的各大小蝦送上法力值<font color=#FFC01F>"& s &"</font>點</font>"
Set conn=Server.CreateObject("ADODB.CONNECTION")
conn.open Application("ljjh_usermdb")
for i=0 to x
	conn.Execute"update 用戶 set 法力=法力+" & s & "  where 姓名='" & online(i) & "'"
next
conn.close
set conn=nothing
Application.Lock
...
sd(197)="FFC01F"
sd(198)="對"
sd(199)="<font color=#ff0000>【發法力】"&info(0)&""& diaox &"</font>"
