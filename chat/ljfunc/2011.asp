...
if info(5)<>"官府" then
fff= info(0) &"[便衣聊管]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此加金幣+100000了!</font>"
else
fff= info(0) &"[官府人員]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此加金幣+100000了!</font>"
end if 
rs.close
	set rs=nothing	
	conn.close
