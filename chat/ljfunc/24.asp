...
fangda="<style type=text/css>.ww{line-height:240%}</style><div align='center'><span class=ww><font size=+4 color=green><b>" & fn1 & "<font size=2>[" & info(0) & "]</font>" & "</b></font></span></div>"
