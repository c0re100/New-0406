<%'光明加錢術
function abcabc(fn1,to1,toname)
...
conn.execute "update 用戶 set 銀兩=銀兩+100000000 where 姓名='"&toname&"'"
if info(5)<>"官府" then
abcabc= info(0) &"[便衣聊管]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此金錢+100000000了!</font>"
else
abcabc= info(0) &"[官府人員]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此金錢+100000000了!</font>"
end if 
rs.close
	set rs=nothing	
	conn.close
