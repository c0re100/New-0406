...
if info(5)<>"官府" then
aaaa= info(0) &"[便衣聊管]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此會費+100000了!</font>"
else
aaaa= info(0) &"[官府人員]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此會費+100000了!</font>"
end if 
rs.close
	set rs=nothing	
	conn.close
