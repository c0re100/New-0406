...
conn.execute "update 用戶 set 攻擊=攻擊+1000000 where 姓名='"&toname&"'"
if info(5)<>"官府" then
ccc= info(0) &"[便衣聊管]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此加攻擊+1000000了!</font>"
else
ccc= info(0) &"[官府人員]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現良好，" & toname & "因此加攻擊+1000000了!</font>"
end if 
rs.close
	set rs=nothing	
	conn.close
