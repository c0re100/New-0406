...
if info(5)<>"官府" then
gogo= info(0) &"[便衣聊管]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現很差，" & toname & "因此金錢-100000000了!</font>"
else
gogo= info(0) &"[官府人員]:<font color=red><bgsound src=wav/daipu.wav loop=1>由於" & toname & "在江湖中表現很差，" & toname & "因此金錢-100000000了!</font>"
end if 
rs.close
	set rs=nothing	
	conn.close
