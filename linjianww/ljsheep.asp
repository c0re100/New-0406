...
<div align="center"> 
  <p><br>
    <font color="#009900"><b><font color="#FF0000" size="+6">[寵物管理]</font></b></font><font
color="#FFFFFF"><br>
    </font> </p>
  </div>
...
bordercolorlight="#000000" bordercolordark="#FFFFFF">
  <tr bgcolor="#99CCFF"> 
    ...
    <td height="27" width="94"> 
      <div align="center"><font color="#FF6600">寵物名</font></div>
    </td>
    <td height="27" width="94"> 
      <div align="center"><font color="#FF6600">寵物技能</font></div>
    </td>
    ...
    <td height="27" width="56"> 
      <div align="center"><font color="#FF6600">價格</font></div>
    </td>
...
rs.open "SELECT * FROM 寵物 ",conn
s=0
do while not rs.eof and not rs.bof
s=s+1
%>
  <form method=POST action='ljsheepok.asp?a=m&id=<%=rs("id")%>'>
...
value="<%=rs("寵物類型")%>" maxlength="255">
      ...
      <td height="2" width="123"> 
        <div align="center"> <img src="../myhome/sheep/image/<%=rs("說明")%>.gif" border="0" alt="<%=rs("寵物類型")%> "> 
          <input type="text" name="b" style="border: 1px solid;background-color:#FFFFDF; font-size: 9pt; border-color:
#000000 solid" size="8"
value="<%=rs("說明")%>" maxlength="255">
        </div>
      </td>
