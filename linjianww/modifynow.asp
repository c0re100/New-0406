...
wupinsmc=abs(trim(Request.Form("wupinsmc")))
...
conn.Execute "update 物品買 set 物品名='"& wupinname &"',類型='"& wupinlx &"',內力="& wupinnl &",體力="& wupintl &",攻擊="& wupingj &",說明='"& wupinsm &"',防御="& wupinfy &",堅固度='"& wupinjg &"',sm="& wupinsmc &",銀兩="& wupinyl &" where id="&ID
sql="insert into 管理記錄 (姓名,時間,ip,記錄) values ('"&info(0)&"',now(),'"&info(15)&"','物品修改操作')"
conn.Execute(sql)
set rs=nothing
conn.close
set conn=nothing
