...
<body text="#000000" link="#000000" vlink="#000000" alink="#000000" bgcolor="#003399" background="0064.jpg">
...
sql="SELECT * FROM 物品買 where  類型='盔甲' order by 銀兩"
