...
<td height="19" width="14%" rowspan="2">
      <div align="center"><a href="addsu.asp">添加裝備</a></div>
</td>
</tr>
<tr>
<td height="9" width="14%">
...
sql="SELECT * FROM 物品買 where  類型='裝飾' order by 銀兩"
...
%>
  <tr bgcolor="#FFFFFF"  onMouseOut="this.bgColor='#FFFFFF';"onMouseOver="this.bgColor='#DFEFFF';"> 
    ...
    <td height="11" width="132">等級需求<%=abs(rs("等級"))%> 增防御<%=abs(rs("防御"))%></td>
