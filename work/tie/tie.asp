...
href="#"
onclick="setTimeout('golian()',0)"><IMG alt=煉鐵 border=0 class=csstext2 height=25
src="image/liantie.gif" width=30></A></SPAN></P>
<FORM action=tiejl.asp name=shiform target=ig>
<INPUT name=actnum type=hidden value=0> <INPUT name=passflag
