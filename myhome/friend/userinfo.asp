...
<div align="center">
<font size="2" color="#E18C59"><b>詳細資料</b></font>
</div>
</td>
<td width="104">

<a href="../../jh.asp" target="_top">到皇城中心逛逛</a>
</td>
</tr>
</table>
</td>
...
bordercolor="#E18C59">
<tr>
<td width="622">該用戶沒有房屋沒有登錄真實資料
<%
rs.close
conn.close
else
if  rs("open")<>"是" and rs("house")<>"0" then%>
該用戶個人資料保密！ <a
href="addusertype.asp?type=友&amp;name=<%=user%>"><font
color="#FFCC00">加入好友列表</font></a> <a
href="addusertype.asp?type=黑&amp;name=<%=user%>"><font
color="#FFCC00">加入黑名單</font></a> <a
href="../Guestbook/send.asp?name=<%=user%>"><font
color="#FFCC00">現在就留言給他</font></a>
<%end if%>
<%
if rs("open")="是"and rs("house")<>"0" then
skin=rs("skin")
...
color="#FFCC00">加入好友列表</font></a> <a
href="addusertype.asp?type=黑&amp;name=<%=user%>"><font
color="#FFCC00">加入黑名單</font></a></td>
<td class="p3" valign="top" width="96"><a
href="../Guestbook/send.asp?name=<%=user%>"><font
color="#FFCC00">現在就留言給他</font></a></td>
</table>
</center>
</div>
</form> <%
