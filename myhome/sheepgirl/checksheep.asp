...
<HTML><HEAD><TITLE>靈劍江湖-江湖托兒所</TITLE>
      ...
      width="100%">
        ...
        <TR>
          ...
          <TD height=25 vAlign=top width="33%">
            <DIV align=center><font color="#000000">江湖托兒所</font></DIV>
          </TD>
...
response.write typelife
                    ...
                    <tr> 
                      <td class="p9" width="100%" colspan="4" height="71">□-你通過不同的方法照顧你的小孩會得到不同的工作量，你只有長時間的積累經驗，每次耐心細致的觀察你的小孩每天的情況，纔能養出打工的工作量很大的小孩來。你的小孩每天可管理三次(一周期),照顧小孩五個周期以上就可以到孤兒院打工了，現在每個工作單位的價格是1個豆子。<br>
