...
<td class="p3" width="97">網站地址：</td>
<td class="p3" width="300">http://<input type="text" name="url"
size="27" value="<%=rs("url")%>"></td>
</tr>
<tr>
<td class="p3" width="10"></td>
<td class="p3" width="95">是否開放：</td>
<td class="p3" width="268"><%if rs("open")="是" then%><input
type="radio" value="是" checked name="open">是<input
type="radio" name="open" value="否">否
<%else%><input type="radio" name="open" value="是">是<input
type="radio" value="否" checked name="open">否<%end if%>
</td>
