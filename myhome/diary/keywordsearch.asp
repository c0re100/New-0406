...
<%
searchsql="select * from diarymessage where "

if trim(request.querystring("keyword"))<>"" then
searchsql=searchsql&"instr(diarymessage,"&"'"&trim(request.querystring("keyword"))&"') and user='"&info(0)&"' order by id desc"
else
%>
...
<div align="center">
<font size="2" color="#E18C59"><b>查詢日記</b></font>
</div>
</td>
<td width="104">
<div align="center">
...
<div align="center" style="width: 692; height: 43">
<div align="center">
<center>
<div align="center">
...
bordercolor="#E18C59">
<tr>
<td class="p1" width="324">□-您的位置-<a
href="../../city.asp"><font color="#FFCC00">皇城中心</font></a>-<a
...
<table border="1" width="324" cellspacing="1" cellpadding="0"
bordercolor="#E18C59">
<tr>
...
<table border="1" width="350" cellspacing="1" cellpadding="0"
bordercolor="#E18C59">
<FORM METHOD="get" ACTION="keywordsearch.asp">
<tr>
<td class="p2" width="10"> </td>
<td class="p2" width="46">轉到：</td>
<td class="p2" width="205" colspan="3"><input type="text"
...
<td class="p2" width="75"> </td>
<td class="p2" width="53"> </td>
</tr>
</form>
<tr>
<td class="p2" width="10"> </td>
<td class="p2" width="46"><%if dqpage>1 then%>
<form method="get" action="keywordsearch222.asp">
<input type="hidden" name="keyword"
value="<%=request.querystring("keyword")%>"><input
type="hidden" name="page" value="1"><input type="submit"
value="首頁">
</form>
<%else%><input type="submit" value="首頁">
<%end if%></td>
<td class="p2" width="46"><%if dqpage>1 then%>
<form method="get" action="keywordsearch222.asp">
<input type="hidden" name="keyword"
...
<%else%><input type="submit" value="上頁"><%end if%></td>
...
<%else%>
<input type="submit" value="下頁"><%end if%></td>
<td class="p2" width="113">
<%if dqpage<totalpage then%>
<form method="get" action="keywordsearch222.asp">
<input type="hidden" name="keyword"
value="<%=request.querystring("keyword")%>"><input
...
<td class="p2" width="75">當前頁：<%=dqpage%></td>
<td class="p2" width="53">總頁：<%=totalpage%></td>
</tr>
</table>
<table border="1" width="347" cellspacing="1" cellpadding="0"
bordercolor="#E18C59">
<tr>
<td class="p2" width="10"> </td>
<td class="p2" width="220">內容概要</td>
<td class="p2" width="30">天氣</td>
<td class="p2" width="55">日期</td>
<td class="p2" width="38">心情</td>
<td class="p2" width="53">點擊量</td>
</tr>
<%
count=0
...
%>
<td class="p3" width="10"> </td>
<td class="p3" width="220"><a
href="readjump.asp?id=<%=rs("id")%>"><font color="#FFCC00"><%=diarymessage%></font></a></td>
<td class="p3" width="30"><font color="#FFCC00"><%=rs("diaryseason")%> </font></td>
<td class="p3" width="55"><font color="#FFCC00"><%=rs("diarydate")%> </font></td>
<td class="p3" width="38"><font color="#FFCC00"><%=rs("mood")%> </font></td>
<td class="p3" width="53"><font color="#FFCC00"><%=rs("clicknumber")%> </font></td>
</tr>
<%
count=count+1
rs.movenext
...
<tr>
<td class="p3" width="10"> </td>
<td class="p3" width="220"> </td>
<td class="p3" width="30"> </td>
<td class="p3" width="55"> </td>
<td class="p3" width="38"> </td>
<td class="p3" width="53"> </td>
</tr>
<%
next
end if
...
<center>
<table border="1" width="690" cellspacing="1" cellpadding="0"
height="104" bordercolor="#E18C59">
<tr>
<td width="324" rowspan="5">
<table border="1" width="324" cellspacing="1" cellpadding="0"
bordercolor="#E18C59">
<tr>
<td class="p3" width="100%" height="19">&nbsp;</td>
</tr>
<tr>
<td class="p3" width="100%" height="19">&nbsp;</td>
</tr>
...
<td class="p3" width="160" colspan="2"><input type="submit"
value="查看" name="B1"></td>
</tr>
</form>
</table>
