...
onclick="window.history.back();">返回</a>&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
</tr>
<tr>
<td class="p2" width="415" height="2" valign="top">
<div align="center"><font size="2">靈劍江湖房屋地產</font></div>
</td>
</tr>
<tr>
...
<table>
<tr>
<td><font size="2">您隻能擁有一所房屋！！如果想要換房屋，請先賣掉以前的房屋！！您的房屋類型是<%=rs1("house")%>所在區為：<%=rs1("bigarea")%></font></td>
</table>
<%
else
...
<table>
<tr>
<td><font size="2">恭喜您！您已經成功的購買了房子！！
：-）</font></td>
</table>
<%
end if
