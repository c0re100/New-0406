...
<TD class=head-l width=660>您當前位置：<a href="../jh.asp"><font color="#FFFFFF">靈劍江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">靈劍大酒店</font></a>-&gt;天長地久宴會</TD>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT id,擁有者,數量,時間 FROM 宴會列表 where  宴會名='天長地久'"
