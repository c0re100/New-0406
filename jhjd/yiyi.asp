...
<TD class=head-l width=660>您當前位置：<a href="../jh.asp"><font color="#FFFFFF">靈劍江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">靈劍大酒店</font></a><font color="#FFFFFF">-&gt;</font>一心一意宴會</TD>
...
<td height="15" bgcolor="#66FF66" bordercolor="#FF6600" width="30%"><font size="2" color="#FF0000">剩餘座位</font></td>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT id,擁有者,數量,門派,時間 FROM 宴會列表 where  宴會名='一心一意'"
...
<td width="30%" bgcolor="#FFFFFF" class="calen-curr"><font size="2"><%=rs("數量")%>個<%=rs("門派")%>酒席</font>
<td width="40%" bgcolor="#FFFFFF" class="calen-curr"><font size="2"><%=rs("時間")%>
</font></td>
<td width="10%" bgcolor="#FFFFFF" class="calen-curr"><font size="2">
<center>
<font size="2">
<%if info(0)=rs("擁有者") or info(5)=rs("門派") then %>
