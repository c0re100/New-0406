...
'<td align=right><a href=javascript:hideLayer('+layername+')><img src="m/no.gif" width=12 height=12 alt=Ãö³¬ border=0></a></td>'+
'</tr></table></td></tr>'+
'<tr><td colspan=3 height=1 width=100% bgcolor=cccccc><img src="m/empty.gif"></td></tr>'+content+'</table></td></tr></table>';
return strReturn;
}
//zhihong_d add end.
