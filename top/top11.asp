...
dim rs
dim filename
sql="select 姓名,性別,門派,身份,道德,法力,體力 from 用戶 where 身份<>'掌門' and 門派<>'官府'order by 法力 desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr bgcolor="#990000"> 
      ...
      <td align="center" height="16" width="8%"><font color="#FFFFFF">法力</font></td>
    ...
    <tr> 
      ...
      <td align="center" width="8%"><font color="#CCFFCC"><%=rs("法力")%></font></td>
