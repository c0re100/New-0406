...
dim rs
dim filename
sql="select 姓名,性別,門派,身份,allvalue,mvalue,times,體力 from 用戶 where 門派<>'官府'order by mvalue desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
%>
  <table border="1" cellspacing="1" width="100%" bordercolorlight="#000000" bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr bgcolor="#990000"> 
      <td align="center" height="16" width="12%"><font color="#FFFFFF">姓名</font></td>
      <td align="center" height="16" width="8%"><font color="#FFFFFF">性別</font></td>
      <td align="center" height="16" width="10%"><font color="#FFFFFF">門派</font></td>
      <td align="center" height="16" width="19%"><font color="#FFFFFF">身份</font></td>
      <td align="center" height="16" width="12%"><font color="#FFFFFF">總積分</font></td>
      <td align="center" height="16" width="8%"><font color="#FFFFFF">月積分</font></td>
      <td align="center" height="16" width="10%"><font color="#FFFFFF">登錄次數</font></td>
      <td align="center" height="16" width="21%"><font color="#FFFFFF">體力</font></td>
    </tr>
    <%do while not rs.eof%>
    <tr> 
      <td align="center" width="12%"><font color="#FFFFFF"><%=rs("姓名")%></FONT></td>
      <td align="center" width="8%"><font color="#CCFFCC"><%=rs("性別")%></font></td>
      <td align="center" width="10%"><font color="#CCFFCC"><%=rs("門派")%></font></td>
      <td align="center" width="19%"><font color="#CCFFCC"><%=rs("身份")%></font></td>
      <td align="center" width="12%"><font color="#CCFFCC"><%=rs("allvalue")%></font> 
      </td>
      <td align="center" width="8%"><font color="#FFDDCC"><%=rs("mvalue")%></font></td>
      <td align="center" width="10%"><font color="#CCFFCC"><%=rs("times")%></font></td>
      <td align="center" width="21%"><font color="#CCFFCC"><%=rs("體力")%></font></td>
    </tr>
    <%
rs.movenext
filename=filename+1
