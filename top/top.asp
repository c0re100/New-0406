...
dim rs
dim filename
sql="select * from 用戶 where 身份<>'掌門' and 門派<>'官府'and 性別='女' order by 武功 desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
%>
  <table border="1" cellspacing="0" width="100%" bordercolorlight="#000000" bordercolordark="#FFFFFF" cellpadding="0">
    <tr> 
      <td align="center" height="17" bgcolor="#990000" width="12%"><font size="2" color="#FFFFFF">姓 
        名</font></td>
      <td align="center" height="17" bgcolor="#990000" width="12%"><font size="2" color="#FFFFFF">門 
        派</font></td>
      <td align="center" height="17" bgcolor="#990000" width="12%"><font size="2" color="#FFFFFF">身 
        份</font></td>
      <td align="center" height="17" bgcolor="#990000" width="12%"><font size="2" color="#FFFFFF">武功</font></td>
      <td align="center" height="17" bgcolor="#990000" width="9%"><font size="2" color="#FFFFFF">攻擊</font></td>
      <td align="center" height="17" bgcolor="#990000" width="10%"><font size="2" color="#FFFFFF">防御</font></td>
      <td align="center" height="17" bgcolor="#990000" width="14%"><font color="#FFFFFF">合計</font></td>
      <td align="center" height="17" bgcolor="#990000" width="19%"><font size="2" color="#FFFFFF">體 
        力</font></td>
    </tr>
    <%do while not rs.eof%>
    <tr> 
