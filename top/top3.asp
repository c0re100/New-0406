...
dim rs
dim filename
sql="select 姓名,門派,身份,武功,攻擊,防御,等級,體力 from 用戶 where 身份<>'掌門' and 門派<>'官府' and 性別='男' order by 武功+攻擊+防御 desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr bgcolor="#990000"> 
      ...
      <td align="center" height="17" width="10%"><font size="2" color="#FFFFFF">戰鬥等級</font></td>
    ...
    <tr> 
      ...
      <td align="center" width="10%"><font color="#FFDDCC"><%=rs("等級")%></font></td>
