...
dim rs
dim filename
sql="select 姓名,ID,門派,身份,銀兩,存款,體力 from 用戶 where 性別='女' and 門派<>'官府' order by (存款+銀兩) desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
<tr bgcolor="#990000">
<td align="center" height="20" width="14%"><font size="2" color="#FFFFFF">姓名</font></td>
<td align="center" height="20" width="14%"><font size="2" color="#FFFFFF">ID</font></td>
<td align="center" height="20" width="14%"><font size="2" color="#FFFFFF">門派</font></td>
<td align="center" height="20" width="14%"><font size="2" color="#FFFFFF">身份</font></td>
<td align="center" height="20" width="12%"><font size="2" color="#FFFFFF">銀兩</font></td>
<td align="center" height="20" width="12%"><font size="2" color="#FFFFFF">存款</font></td>
<td align="center" height="20" width="15%"><font size="2" color="#FFFFFF">合計</font></td>
<td align="center" height="20" width="19%"><font size="2" color="#FFFFFF">體力</font></td>
</tr>
<%do while not rs.eof%>
<tr>
<td align="center" width="14%"><font color="#FFFFFF"><%=rs("姓名")%></font></td>
<td align="center" width="14%"><font color="#CCFFCC"><%=rs("ID")%></font></td>
<td align="center" width="14%"><font color="#CCFFCC"><%=rs("門派")%></font></td>
<td align="center" width="14%"><font color="#CCFFCC"><%=rs("身份")%></font></td>
<td align="center" width="12%"><font color="#CCFFCC"><%=rs("銀兩")%></font></td>
<td align="center" width="12%"><font color="#CCFFCC"><%=rs("存款")%></font></td>
<td align="center" width="15%"><font color="#FFDDCC"><%=rs("存款")+rs("銀兩")%></font></td>
