...
dim rs
dim filename
sql="select 姓名,性別,門派,身份,allvalue,mvalue,times,會員等級,體力 from 用戶 where 門派<>'官府'order by allvalue desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr bgcolor="#990000"> 
      <td align="center" height="16" width="9%"><font color="#FFFFFF">姓名</font></td>
      <td align="center" height="16" width="6%"><font color="#FFFFFF">性別</font></td>
      <td align="center" height="16" width="16%"><font color="#FFFFFF">門派</font></td>
      <td align="center" height="16" width="22%"><font color="#FFFFFF">身份</font></td>
      <td align="center" height="16" width="11%"><font color="#FFFFFF">總積分</font></td>
      <td align="center" height="16" width="8%"><font color="#FFFFFF">月積分</font></td>
      <td align="center" height="16" width="8%"><font color="#FFFFFF">登錄次數</font></td>
      <td align="center" height="16" bgcolor="#FFFFFF" width="7%">會員等級</td>
      <td align="center" height="16" width="13%"><font color="#FFFFFF">體力</font></td>
    </tr>
    <%do while not rs.eof%>
    <tr> 
      <td align="center" width="9%"><font color="#FFFFFF"><%=rs("姓名")%></font></td>
      <td align="center" width="6%"><font color="#CCFFCC"><%=rs("性別")%></font></td>
      <td align="center" width="16%"><font color="#CCFFCC"><%=rs("門派")%></font></td>
      <td align="center" width="22%"><font color="#CCFFCC"><%=rs("身份")%></font></td>
      <td align="center" width="11%"><font color="#FFDDCC"><%=rs("allvalue")%></font> </td>
      <td align="center" width="8%"><font color="#CCFFCC"><%=rs("mvalue")%></font></td>
      <td align="center" width="8%"><font color="#CCFFCC"><%=rs("times")%></font></td>
      <td align="center" width="7%"><font color="#CCFFCC"><%=rs("會員等級")%>級</font></td>
      <td align="center" width="13%"><font color="#CCFFCC"><%=rs("體力")%></font></td>
    </tr>
    <%
rs.movenext
filename=filename+1
