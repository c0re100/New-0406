...
dim rs
dim filename
sql="select 姓名,性別,門派,身份,道德,魅力,體力 from 用戶 where 身份<>'掌門' and 門派<>'官府'order by 道德+魅力 desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr bgcolor="#990000"> 
      ...
      <td align="center" height="16" width="8%"><font color="#FFFFFF">魅力</font></td>
      <td align="center" height="16" width="11%"><font color="#FFFFFF">合計</font></td>
    ...
    <tr> 
      ...
      <td align="center" width="7%"><font color="#FFDDCC"><%=rs("道德")%></font> 
      </td>
      <td align="center" width="8%"><font color="#CCFFCC"><%=rs("魅力")%></font></td>
      <td align="center" width="11%"><font color="#CCFFCC"><%=rs("魅力")+rs("道德")%></font></td>
