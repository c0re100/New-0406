      ...
      width="409" cellspacing="2" cellpadding="1" bordercolor="#65251C">
        <tr> 
          <td colspan="5" height="33"> 
            <div align="center"> 
              <p><font size="+2" color="#FF0000">升級武器</font></p>
              <p><font size="2" color="#660066">條件：流星<img src="../JHJS/001/111111.gif" width="23" height="21" border="0" alt="點擊煉寶">可用來升級武器<br>
                等級越高升級成功機率越小！</font><font size="+2" color="#0099FF"> </font></p>
            </div>
          </td>
        </tr>
      </table>
...
%>
                <tr align="center"> 
                  ...
                  <td width="12%" height="15"><a href="liuxingok.asp?id=<%=rs("ID")%>">升級</a></td>
                </tr>
                <%
rs.movenext
loop
