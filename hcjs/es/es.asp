...
rs.open "select 物品名,id from 物品 where id=" & id & " and 類型<>'卡片' and 數量>="&sl&" and 擁有者="&info(9),conn
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('提示：操作不成功，你沒有這樣的物品！');location.href = 'javascript:history.go(-1)'</script>"
	response.end
end if
wpname=rs("物品名")
%>
...
<tr valign="top">
    <td bgcolor=#99CCFF height="226"> 
      <div align="center">
<p><font size="3" color="#000000">二手</font><font size="3" color="#000000">物品</font><font color="#FF3333" size="3"><br>
</font> </p>
...
<tr>
<td height="179">
<form method=POST action='es1.asp?id=<%=rs("id")%>&sl=<%=sl%>'>
<div align="left">
...
個<br>
<font size="3" color="#000000">二手金額</font>:
...
<input type="text" name="zy" size="30" value="寫上你要說的話" style="color: #000000; background-color: #88B0D8; text-decoration: blink; border: 1px solid #000080" onMouseOver="this.style.backgroundColor = '#FFCC00'" onMouseOut="this.style.backgroundColor = '#88B0D8'" maxlength="19">
&nbsp; </p>
<p align="center">
<input type=submit value=確定交易 name="submit" style="border: 1px solid; font-size: 9pt; border-color:
#000000 solid">
