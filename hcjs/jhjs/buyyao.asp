...
response.end
	...
	Response.Write "<script Language=Javascript>alert('提示：購買["&wu&"]物品"&sl&"個成功,如果您是會員可以打5折！');location.href = 'javascript:history.go(-1)';</script>"
response.end
end if
%>
