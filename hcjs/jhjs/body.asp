...
<body bgcolor="#003399" background="../../ff.jpg" leftmargin="0" topmargin="0">
...
href="anqi.asp"><font color="#6666FF">暗器</font></a></div></td></tr> </table>
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#99CCFF">
        <tr align="center" bgcolor="#FF0000"> 
          <td width="58"><font color="#FFFFFF">裝備名</font></td>
          <td width="86"><font color="#FFFFFF"> 武 器 圖</font></td>
          <td width="56"><font color="#FFFFFF">類型 </font> 
          <td width="231"><font color="#FFFFFF">功能</font></td>
          <td width="56"><font color="#FFFFFF">售價</font></td>
          <td colspan="2"><font color="#FFFFFF">數 量</font></td>
...
rs.open "SELECT 物品名,id,說明,等級,類型,防御,堅固度,銀兩 FROM 物品買 where 類型='盔甲' order by 銀兩 ",conn
...
%>
        <tr bgcolor="#FFFFFF"  onmouseout="this.bgColor='#FFFFFF';"onmouseover="this.bgColor='#DFEFFF';"> 
          <form method=POST action='binqi1.asp?id=<%=rs("id")%>'>
            <td width="58"> <div align="center"><%=rs("物品名")%></div></td>
            <td width="86"> <div align="center"><img src="001/<%=rs("說明")%>.gif" border="0" alt="<%=rs("物品名")%> "></div></td>
            <td width="56"> <div align="center"><%=rs("類型")%> </div></td>
            <td width="231"> <div align="center">等級需求<%=abs(rs("等級"))%>，加防御<%=abs(rs("防御"))%>，堅固度<%=abs(rs("堅固度"))%></div></td>
            <td width="56"> <div align="center"><%=rs("銀兩")%>兩</div></td>
