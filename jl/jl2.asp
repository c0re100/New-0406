...
PageSize = 15
rs.open "delete * from 事務 where 行為時間<now()-3",conn,3,3
rs.open "Select 管理捕快,行為時間,管理對像,原因 From 事務 where 管理方式='警告' Order by 行為時間 DESC",conn,3,3
...
<tbody>
<tr>
<td height="15" width="100%" bgcolor="#669999"><font color="#669966"> <font color="#FFFFFF"><b>江湖警告</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<div align="center">[<a href="jl2.asp?page=<%=page-1%>">上一頁</a>][第<%=page%>頁][<a href="jl2.asp?page=<%=page+1%>">下一頁</a>]</div>
</td>
</tr>
</table>
</table>
