...
rs.open "Select 姓名1,時間,姓名2,數據 From 操作記錄 where 方式='獎勵' Order by 時間 DESC",conn,3,3
...
<div align="center">[<a href="jl7.asp?page=<%=page-1%>">上一頁</a>][第<%=page%>頁][<a href="jl7.asp?page=<%=page+1%>">下一頁</a>]</div>
</td>
</tr>
</table>
</table>
