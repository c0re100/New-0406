...
PageSize = 15
set rs=server.createobject("adodb.recordset")
rs.open "delete * from 操作記錄 where 時間<now()-10",conn,3,3
rs.open "Select 姓名1,時間,姓名2,數據 From 操作記錄 where 方式='傳授經驗' Order by 時間 DESC",conn,3,3
...
<tbody>
<tr>
<td height="15" width="100%" bgcolor="#669999"><font color="#669966"> <font color="#FFFFFF"><b>江湖傳授經驗</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<div align="center">[<a href="jl9.asp?page=<%=page-1%>">上一頁</a>][第<%=page%>頁][<a href="jl9.asp?page=<%=page+1%>">下一頁</a>]</div>
</td>
</tr>
</table>
</table>
