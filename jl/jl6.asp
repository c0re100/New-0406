...
PageSize = 15
rs.open "delete * from 事務 where 行為時間<now()-6",conn,3,3
rs.open "Select 管理捕快,行為時間,管理對像,原因 From 事務 where 管理方式='解除監禁' Order by 行為時間 DESC",conn,3,3
...
<tbody>
<tr>
<td height="15" width="100%" bgcolor="#669999"><font color="#669966"> <font color="#FFFFFF"><b>江湖解除監禁</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<tr bgcolor="#FFFFFF">
<td width="11%">
<div align="center"><font color="#FF6600"> 管 理 員 </font></div>
</td>
<td width="18%">
<div align="center"><font color="#FF6600"> 時 間 </font></div>
</td>
<td width="12%">
<div align="center"><font color="#FF6600"> 管理對像 </font></div>
</td>
<td width="59%">
...
<td width="11%">
<div align="center"> <font color="#0000FF"><%=rs("管理捕快")%></font>
</div>
</td>
<td width="18%">
<div align="center"> <%=rs("行為時間")%> </div>
</td>
<td width="12%">
<div align="center"> <%=rs("管理對像")%> </div>
</td>
<td width="59%">
<div align="center"> <%=rs("原因")%> </div>
</td>
</tr>
<%rs.movenext%>
<%count=count+1%>
...
<div align="center">[<a href="jl6.asp?page=<%=page-1%>">上一頁</a>][第<%=page%>頁][<a href="jl6.asp?page=<%=page+1%>">下一頁</a>]</div>
</td>
</tr>
</table>
</table>
